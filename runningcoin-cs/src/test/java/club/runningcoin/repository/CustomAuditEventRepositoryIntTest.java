...
import club.runningcoin.config.audit.AuditEventConverter;
import club.runningcoin.domain.PersistentAuditEvent;
...
import static club.runningcoin.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
